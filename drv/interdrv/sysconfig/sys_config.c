...
static char sensor_list[SENSOR_LIST_CMDLINE_LEN]= "sns0=imx327,sns1=imx327";  /* imx335 imx327 imx327_2l imx307 imx307_2l os05a imx290 imx377 imx458 imx206 imx34220 */
static char chip_list[CHIP_NAME_LEN] = "hi3516dv300";  /* hi3516cv500  hi3516dv300 */
...
{
    reg_write32(clock << ((6 * index) + 2), 0xF << ((6 * index) + 2), (unsigned long)reg_crg_base+0x00F0);
}
...
unsigned int parse_sensor_clock(char *name)
{
    ...
    else if ((0 == strncmp("imx458", name, len))
          || (0 == strncmp("imx377", name, len))
          || (0 == strncmp("os05a", name, len)))
    {
        clock = 0x4;
...
int clkcfg(char *s, int cmos_yuv_flag)
{
    ...
    if (0 == strncmp("hi3516dv300", s, CHIP_NAME_LEN))
    {
    ...
    else if (0 == strncmp("hi3516cv500", s, CHIP_NAME_LEN))
    {
    ...
    {
        SYS_WRITEL(reg_crg_base+0x00A0, 0x00482c00);
...
{
    SYS_WRITEL(reg_iocfg_base+0x0074, 0x412);
    SYS_WRITEL(reg_iocfg_base+0x0078, 0x412);
}

void i2c1_pin_mux(void)
{
    SYS_WRITEL(reg_iocfg_base+0x007C, 0x412);
    SYS_WRITEL(reg_iocfg_base+0x0080, 0x512);
}

void i2c2_pin_mux(void)
{
    SYS_WRITEL(reg_iocfg1_base+0x0018, 0x511);
    SYS_WRITEL(reg_iocfg1_base+0x001C, 0x511);
}

void i2c3_pin_mux(void)
{
    SYS_WRITEL(reg_iocfg2_base+0x0090, 0x511);
    SYS_WRITEL(reg_iocfg2_base+0x008C, 0x511);
...
{
    SYS_WRITEL(reg_iocfg_base+0x0074, 0x411);
    SYS_WRITEL(reg_iocfg_base+0x0078, 0x411);
    SYS_WRITEL(reg_iocfg_base+0x007C, 0x411);
    SYS_WRITEL(reg_iocfg_base+0x0080, 0x511);
}

void spi1_pin_mux(void)
{
    SYS_WRITEL(reg_iocfg2_base+0x0020, 0x631);
    SYS_WRITEL(reg_iocfg2_base+0x0024, 0x661);
    SYS_WRITEL(reg_iocfg2_base+0x002c, 0x421);
    SYS_WRITEL(reg_iocfg2_base+0x0028, 0x5f1);
}
...
{
    SYS_WRITEL(reg_iocfg2_base+0x0034 ,0x402);
    SYS_WRITEL(reg_iocfg2_base+0x0058 ,0x452);
    SYS_WRITEL(reg_iocfg2_base+0x004c ,0x452);
    SYS_WRITEL(reg_iocfg2_base+0x0054 ,0x452);
    ...
    SYS_WRITEL(reg_iocfg2_base+0x0060 ,0x422);
}
...
void i2s0_pin_mux(void)
{
    ...
    SYS_WRITEL(reg_iocfg2_base+0x0030 ,0x573);
}
...
void sensor_bus_pin_mux(int index, BUS_TYPE bus_type, char *name)
{
    unsigned int len;
