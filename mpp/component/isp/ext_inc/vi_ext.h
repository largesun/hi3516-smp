...
#define CKFN_VI_IspClearInputQueue()\
    (HI_NULL != FUNC_ENTRY(VI_EXPORT_FUNC_S, HI_ID_VI)->pfnViIspClearInputQueue)
...
#define CKFN_VI_GetViFrameInterruptAttr()\
    (HI_NULL != FUNC_ENTRY(VI_EXPORT_FUNC_S, HI_ID_VI)->pfnViGetViFrameInterruptAttr)
...
#define CKFN_VI_SetVpssFrameInterruptAttr()\
    (HI_NULL != FUNC_ENTRY(VI_EXPORT_FUNC_S, HI_ID_VI)->pfnViSetVpssFrameInterruptAttr)
...
#define CKFN_VI_GetPipeNRXStatus()\
    (HI_NULL != FUNC_ENTRY(VI_EXPORT_FUNC_S, HI_ID_VI)->pfnViGetPipeNRXStatus)
...
#define CKFN_VI_GetFusionGroupAttr()\
    (HI_NULL != FUNC_ENTRY(VI_EXPORT_FUNC_S, HI_ID_VI)->pfnViGetFusionGroupAttr)
...
#define CKFN_VI_GetIspConfig()\
    (HI_NULL != FUNC_ENTRY(VI_EXPORT_FUNC_S, HI_ID_VI)->pfnViGetIspConfig)
