...
{
    pstUsrRegCfg->bFusionMode        = pstFSWDR->bFusionMode;//HI_ISP_FUSION_MODE_DEFAULT;
    pstUsrRegCfg->bShortExpoChk      = pstFSWDR->bShortExpoChk;//HI_ISP_WDR_SHORT_EXPO_CHK_DEFAULT;
    pstUsrRegCfg->u8MdtLBld          = pstFSWDR->u8MdtLBld;
    pstUsrRegCfg->u8MdtStillThr      = pstFSWDR->u8MdtStillThr;
    pstUsrRegCfg->u8MdtFullThr       = pstFSWDR->u8MdtFullThr;//HI_ISP_WDR_MDT_FULL_THR_DEFAULT;
...
{
    pstSyncRegCfg->bFusionMode       = pstFSWDR->bFusionMode;//HI_ISP_FUSION_MODE_DEFAULT;
    pstSyncRegCfg->bWDRMdtEn         = pstFSWDR->bMdtEn;//HI_ISP_WDR_MDT_EN_DEFAULT;
    pstSyncRegCfg->u16ShortThr       = pstFSWDR->u16ShortThr;//HI_ISP_WDR_SHORT_THR_DEFAULT;
    pstSyncRegCfg->u16LongThr        = pstFSWDR->u16LongThr;//HI_ISP_WDR_LONG_THR_DEFAULT;
}

static HI_VOID FrameWDRSDynaRegsInitialize(VI_PIPE ViPipe, HI_U8 u8WDRMode, ISP_FSWDR_DYNA_CFG_S *pstDynaRegCfg, ISP_FS_WDR_S *pstFSWDR)
{
    ...
    pstDynaRegCfg->bWDRMdtEn         = pstFSWDR->bMdtEn;//HI_ISP_WDR_MDT_EN_DEFAULT;
    ...
    pstDynaRegCfg->u16ShortThr       = pstFSWDR->u16ShortThr;//HI_ISP_WDR_SHORT_THR_DEFAULT;
    pstDynaRegCfg->u16LongThr        = pstFSWDR->u16LongThr;//HI_ISP_WDR_LONG_THR_DEFAULT;
    ...
    pstDynaRegCfg->bErosionEn        = pstFSWDR->bErosionEn;//HI_ISP_WDR_EROSION_EN_DEFAULT;
