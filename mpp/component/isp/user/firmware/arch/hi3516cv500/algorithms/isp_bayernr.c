...
HI_S32 NRLimitLut(VI_PIPE ViPipe, ISP_BAYERNR_DYNA_CFG_S *pstBayernrDynaCfg, ISP_BAYERNR_S *pstBayernr, HI_U32 u32Iso, HI_U32 u32ISO1, HI_U32 u32ISO2, HI_U16 u16BlackLevel)
{
    HI_U16 str;
...
HI_S32 hiisp_bayernr_fw(HI_U32 u32Iso, VI_PIPE ViPipe, HI_U8 u8CurBlk, ISP_BAYERNR_DYNA_CFG_S *pstBayernrDynaCfg,
                        ISP_BAYERNR_USR_CFG_S *pstBayernrUsrCfg, HI_U16 u16BlackLevel)
{
    ...
    NRLimitLut(ViPipe, pstBayernrDynaCfg, pstBayernr, u32Iso, u32ISO1, u32ISO2, u16BlackLevel);
...
HI_S32 hiisp_bayernr_fw_wdr(HI_U32 u32Iso, VI_PIPE ViPipe, ISP_BAYERNR_DYNA_CFG_S *pstBayernrDynaCfg, ISP_BAYERNR_USR_CFG_S *pstBayernrUsrCfg, HI_U16 u16BlackLevel)
{
                      ...
                      HI_VOID *pRegCfg, HI_S32 s32Rsv)
{
    ...
    for ( i = 0; i < pstIspCtx->stBlockAttr.u8BlockNum; i++)
    {
        ...
        if (pstBayernr->u8WdrFramesMerge > 1)
        {
            hiisp_bayernr_fw_wdr(pstIspCtx->stLinkage.u32Iso, ViPipe, &pstRegCfg->stAlgRegCfg[i].stBnrRegCfg.stDynaRegCfg,
                                 &pstRegCfg->stAlgRegCfg[i].stBnrRegCfg.stUsrRegCfg, u16WDRInBLC);
        }
        else
        {
            hiisp_bayernr_fw(pstIspCtx->stLinkage.u32Iso, ViPipe, i, &pstRegCfg->stAlgRegCfg[i].stBnrRegCfg.stDynaRegCfg,
