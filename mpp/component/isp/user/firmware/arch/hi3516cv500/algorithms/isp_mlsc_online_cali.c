...
{
    HI_S32 s32Height   = (HI_S32)stLSCCaliCfg->u16ImgHeight / 2;
    HI_S32 s32Width    = (HI_S32)stLSCCaliCfg->u16ImgWidth / 2;
...
static HI_VOID GeometricGridSizeX(ISP_MLSC_CALIBRATION_CFG_S *pstLSCCaliCfg, ISP_LSC_Grid_Step_S *pstLscGridStepXY, ISP_MESH_SHADING_TABLE_S *pstLSCCaliResult)
{
    ...
    u32Width = pstLSCCaliCfg->u16ImgWidth / 2;
...
static HI_VOID GeometricGridSizeY(ISP_MLSC_CALIBRATION_CFG_S *pstLSCCaliCfg, ISP_LSC_Grid_Step_S *pstLscGridStepXY, ISP_MESH_SHADING_TABLE_S *pstLSCCaliResult)
{
    ...
    //Read Image info
    u32Height = pstLSCCaliCfg->u16ImgHeight / 2;
                                  ...
                                  ISP_MESH_SHADING_TABLE_S *pstMLSCTable)
{
    ...
    stRLSCCaliCfg.u32Height = pstMLSCCaliCfg->u16ImgHeight;
    stRLSCCaliCfg.u32Width = pstMLSCCaliCfg->u16ImgWidth;
    stRLSCCaliCfg.u32Stride = pstMLSCCaliCfg->u16ImgWidth;
    stRLSCCaliCfg.u32BeginPosX = pstMLSCCaliCfg->u16ImgWidth / 2;
    stRLSCCaliCfg.u32BeginPosY = pstMLSCCaliCfg->u16ImgHeight / 2;
    stRLSCCaliCfg.u32EndPosX = pstMLSCCaliCfg->u16ImgWidth;
    stRLSCCaliCfg.u32EndPosY = pstMLSCCaliCfg->u16ImgHeight;
    ...
    s32Ret = RLSC_GenerateGainInfo(pu16SrcRaw, &stRLSCCaliCfg, pstMLSCTable);
    if (s32Ret == HI_FAILURE)
    {
