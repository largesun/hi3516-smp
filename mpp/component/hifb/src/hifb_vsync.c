...
#define vsync_len 64
static int vsync_major = 288;
static int vsync_minor = 0;
static dev_t vsync_devno;
static struct class* vsync_cls;
static struct device* vsync_device;

static int pts_major = 289;
static int pts_minor = 0;
...
int hifb_vsync_init(void)
{
    ...
    register_chrdev(vsync_major, "vsync", &vsync_ops);
...
int hifb_pts_init(void)
{
    ...
    register_chrdev(pts_major, "vsync_pts", &pts_ops);
