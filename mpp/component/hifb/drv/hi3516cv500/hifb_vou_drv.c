...
HI_BOOL HIFB_DRV_EnableDcmp(HI_U32 u32LayerId, HI_BOOL bEnable)
{
    ...
    return VOU_GraphicsEnableDcmp(s_HifbLayerToHwLayer[u32LayerId], bEnable);
...
HI_BOOL HIFB_DRV_GetDcmpEnableState(HI_U32 u32LayerId, HI_BOOL *pbEnable)
{
    ...
    return VOU_GraphicsGetDcmpEnableState(s_HifbLayerToHwLayer[u32LayerId], pbEnable);
...
HI_BOOL HIFB_DRV_GraphicsGetInterruptDev(HI_U32 IntStatus, VO_DEV* pVoDev)
{
