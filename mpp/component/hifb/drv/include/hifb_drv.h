...
typedef struct
{
    ...
    HI_BOOL              bCallBack;
    HI_VOID*             pParam;
    HIFB_ROTATE_MODE_E   enRotateMode; // new
}HIFB_ROTATE_OPT_S;
...
typedef struct {
    ...
    /* blit for hifb*/
    //HI_S32 (*HIFB_DRV_Blit)(HIFB_BUFFER_S *pstSrcImg, HIFB_BUFFER_S *pstDstImg,  HIFB_BLIT_OPT_S *pstOpt, HI_BOOL bScreenRefresh);
    ...
    HI_BOOL (*HIFB_DRV_GraphicsGetINTDev)(HI_U32 IntStatus, VO_DEV* pVoDev);
}HIFB_DRV_OPS_S;
