...
/* define vo channel buffer's default length */
#define VO_CHN_BUF_DEF_LEN  8
...
//typedef HI_S32  FN_VO_GraphicsGetLayerAttr(HI_U32 u32GraphicLayer, VO_GRAPHIC_ATTR_S *pstVoGfxAttr);
// For graphics ZME
...
#define CKFN_VOU_CheckHdmiEn() \
    (NULL != FUNC_ENTRY(VOU_EXPORT_FUNC_S, HI_ID_VO)->pfnVouCheckHdmiEn)
